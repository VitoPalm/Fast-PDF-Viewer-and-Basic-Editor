...
Current version after the Batch 1 stabilization and large test tooling work:
`1.3.1`.
...
```bash
npm run version:set -- 1.3.1
```

Tagged release builds should use tags shaped like `v1.3.1`. Packaging scripts
